const cycles = [
    ...
    { name: 'Plan your cycle trip', detail: 'I can share tips for Eurasia route', time: '1 hour', price: '100 CHF', imgSrc: '/assets/images/route.jpg' },
    { name: 'How to find sponsors', detail: 'I can tell you how I got 20,000 EUR sponsorship from 13 companies', time: '1 hour', price: '100 CHF', imgSrc: '/assets/images/sponsor.jpg' },
    { name: 'How to train yourself', detail: 'I trained myself in 3 months', time: '30 minutes', price: '30 CHF', imgSrc: '/assets/images/train.jpg' },
     ];
    ...
    let cycleCard = `
         <div class="d-flex mb-4">
            ...
            <div class="info d-none">
                    ...
                    <div class="card-text mt-4"><strong>link:</strong> ${cycle.link}</div>
...
for (let i = 0; i < clickElements.length; i++) {
    ...
    clickElements[i].addEventListener('mouseout', function () {
        clickElements[i].src = cycle[i].imgSrc;
    });
}
